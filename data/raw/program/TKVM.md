...
## Vị trí và khả năng làm việc sau tốt nghiệp
...
| **TC** | **LT** | **TH[**\[1\]**](file:///G:/My%20Drive/DuLieu/daa/CTDT/2024/CTDT_nga%CC%80nh%20TKVM_ca%CC%A3%CC%82p%20nha%CC%82t%202024_Khoa.docx#_ftn1)** |
...
## Mô tả các môn học mới và việc xét tương đương môn học
...
[![](/sites/daa/files/uploads/tkvm_2024_update.png)](/sites/daa/files/uploads/tkvm_2024_update.png)

## Kế hoạch giảng dạy theo học kỳ

Chương trình Thiết kế vi mạch gồm 8 học kỳ chính. 
...
| **Mã MH** | **Tên môn học (Tiếng Việt)**   | **Tên môn học (Tiếng Anh)**            | **Loại MH** | **Tín chỉ** | **LT** | **TH** |
| --------- | ------------------------------ | -------------------------------------- | ----------- | ----------- | ------ | ------ |
| IT003     | Cấu trúc dữ liệu và giải thuật | Data Structures and Algorithms         | Bắt buộc    | 4           | 3      | 1      |
...
| SS010     | Lịch sử Đảng cộng sản VN     | History of Vietnamese communist party | Bắt buộc    | 2           | 2      | 0      |
| **Tổng**  | **Tổng số tín chỉ HK 4**     |                                       |             | **20**      |        |        |
...
| **Mã MH** | **Tên môn học (Tiếng Việt)**  | **Tên môn học (Tiếng Anh)**                | **Loại MH** | **Tín chỉ** | **LT** | **TH** |
| --------- | ----------------------------- | ------------------------------------------ | ----------- | ----------- | ------ | ------ |
| CE226     | Thiết kế VLSI                 | VLSI Design                                | Bắt buộc    | 4           | 3      | 1      |
...
| **Mã MH** | **Tên môn học (Tiếng Việt)** | **Tên môn học (Tiếng Anh)**            | **Loại MH** | **Tín chỉ** | **LT** | **TH** |
| --------- | ---------------------------- | -------------------------------------- | ----------- | ----------- | ------ | ------ |
| CE208     | Đồ án TKVM 2                 | Project of Integrated Circuit Design 2 | Bắt buộc    | 2           | 0      | 2      |
...
| **Mã MH** | **Tên môn học (Tiếng Việt)** | **Tên môn học (Tiếng Anh)** | **Loại MH** | **Tín chỉ** | **LT** | **TH** |
| --------- | ---------------------------- | --------------------------- | ----------- | ----------- | ------ | ------ |
| CE505     | Khóa luận tốt nghiệp         | Capstone Project            | Bắt buộc    | 10          | 0      | 10     |
| **Tổng**  | **Tổng số tín chỉ HK 8**     |                             |             | **10**      |        |        |
